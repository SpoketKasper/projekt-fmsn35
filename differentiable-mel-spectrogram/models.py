...
import adaptive_time_frequency as atf
...
class DASTFTSpectrogramLayer(nn.Module):
    def __init__(self, init_lambd, device='cpu', hop_length=1, normalize_window=False):
        ...
        self.register_buffer('stride_param', torch.tensor([hop_length], dtype=torch.float32))
    ...
    def forward(self, x):
        ...
        spectrograms = torch.empty((batch_size, 1, F, T), 
